<<<<<<< HEAD:src/main/java/control/Version.java
package control;
...
public class Version 
{
	...
	private Version()
	{
		...
		m_AboutText += "           Disabling incomplete features ï¿½ Diasend temporary basals and OmniPod binary file reader\r\n";
		...
		m_AboutText += "           Reference to Online help ï¿½ link to PDF on Google Drive\r\n";
		m_AboutText += " 2.6     - Release introducing the following\r\n";
		m_AboutText += "           Support for T:Slim exports\r\n";
		m_AboutText += "           Fixes to MongoDB Reads as reported by Mï¿½tyï¿½si Pï¿½ter\r\n";
		...
		m_AboutText += " 4.0       Fixes to make it work with Atlas MongoDB - \r\n";
		m_AboutText += "               Address Diasend change to export file\r\n";
...
>>>>>>> master:src/davidRichardson/Version.java

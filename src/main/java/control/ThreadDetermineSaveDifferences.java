...
public class ThreadDetermineSaveDifferences implements Runnable 
{
	...
	public ThreadDetermineSaveDifferences(DataLoadNightScoutTreatments   dataLoadNightScout,
			...
			ThreadDataLoad       threadDataLoadNightScout,
			ThreadDataLoad       threadDataLoadNightScoutEntries,
			ThreadDataLoad       threadDataMeter,
			String deviceUsed,
			String fileName,
			String dateRange)
	{
		...
		m_Logger.log(Level.INFO, "ThreadDetermineSaveDifferences thread created");
	}
	...
	public void run() 
	{
		...
		m_Logger.log(Level.INFO, "ThreadDetermineSaveDifferences - Wait for meter thread - done ");
		...
		if (m_MeterLoadThread != null) m_MeterArrayListDBResultEntries = this.m_MeterLoadThread.getM_DataLoader().getRawEntryResultsFromDB();

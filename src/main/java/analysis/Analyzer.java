...
public class Analyzer extends DataExportExcel 
{
	...
	public Analyzer(ArrayList <DBResult> results, ArrayList<DBResultEntry> resultEntries)
	{
		initialize(results, resultEntries);
	}

	public Analyzer(ArrayList <DBResult> results, ArrayList<DBResultEntry> resultEntries, boolean summaryOnly)
	{
		m_SummaryOnly = summaryOnly;
		initialize(results, resultEntries);
	}

	public Analyzer(ArrayList <DBResult> results, ArrayList<DBResultEntry> resultEntries, Analyzer.AnalyzerMode mode)
	{
		m_AnalyzerMode = mode;
		initialize(results, resultEntries);
	}
...
//			if (bg != null && (startDateLong <= currDateLong) && (endDateLong >= currDateLong))
	...
	{	
		...
		if (applicableIndividualList != null && singleResult != null)
		{

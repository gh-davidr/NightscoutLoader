...
import entity.TextLineReceiverInterface;
...
public class RemoteLinuxServer 
{
	...
	public class RemoteLinuxServerHostDetails
	{
		...
		public RemoteLinuxServerHostDetails()
		{
	...
	public RemoteLinuxServer(Date startDate, Date endDate)
	{
		m_JSch = new JSch();
	...
	public RemoteLinuxServer(Date startDate, Date endDate, TextLineReceiverInterface tlri)
	{
		m_JSch = new JSch();
		m_OutputStream = new String();
		m_StartDate = new Date(startDate.getTime());
	...
	public RemoteLinuxServer(TextLineReceiverInterface tlri)
	{
		m_JSch = new JSch();
		m_OutputStream = new String();

...
public class OmniPodBinaryFileSection 
{
	...
	public OmniPodBinaryFileSection(String sectionHeader, String encoding, String[] fieldNames)
	{
	...
	public OmniPodBinaryFileSection(String sectionHeader, String encoding, 
			String[] fieldNames, 

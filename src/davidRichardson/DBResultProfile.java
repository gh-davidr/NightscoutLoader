...
public class DBResultProfile extends DBResultCore 
{
	 ...
	 */
	public DBResultProfile(String m_ID, Double m_Unfiltered, Double m_Filtered, String m_Direction, String m_Device,
...
//		this.m_SGV = m_SGV;
	...
	public  DBResultProfile(DBObject rs)
	{
...
//		m_SGV           = CommonUtils.getFieldDouble(rs, "sgv");
	...
	{ 
		...
		DBResultProfile guest = (DBResultProfile) obj;
